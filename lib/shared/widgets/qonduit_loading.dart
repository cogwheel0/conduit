...
/// Standard loading indicators following Qonduit design patterns
class QonduitLoading {
...
class _LoadingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final resolvedColor = color ?? context.qonduitTheme.loadingIndicator;
  ...
  Widget build(BuildContext context) {
    return Container(
      color: darkBackground
          ? context.qonduitTheme.surfaceBackground.withValues(
              alpha: Alpha.strong,
            )
          : context.qonduitTheme.surfaceBackground.withValues(
              alpha: Alpha.intense,
      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            color: darkBackground
                ? context.qonduitTheme.surfaceBackground
                : context.qonduitTheme.surfaceBackground,
            borderRadius: BorderRadius.circular(AppBorderRadius.lg),
            boxShadow: QonduitShadows.high(context),
          ),
          child: QonduitLoading.primary(
            size: IconSize.xl,
...
class LoadingButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AdaptiveButton.child(
      ...
      color: isPrimary ? context.qonduitTheme.buttonPrimary : null,
      style: AdaptiveButtonStyle.filled,
      child: isLoading ? QonduitLoading.button(context: context) : child,
    );
  }
}

/// Refresh indicator with Qonduit styling.
///
...
class QonduitRefreshIndicator extends StatelessWidget {
  final Widget child;
      ...
      children: [
        SizedBox(
          ...
          child: LinearProgressIndicator(
            ...
            backgroundColor: context.qonduitTheme.dividerColor,
            valueColor: AlwaysStoppedAnimation<Color>(
              context.qonduitTheme.buttonPrimary,
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        if (isLoading)
          Container(
            color: context.qonduitTheme.surfaceBackground.withValues(
              alpha: Alpha.overlay,
            ),
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: QonduitShadows.card(context),
                ),
