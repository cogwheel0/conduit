...
/// Qonduit custom rendering pipeline.
///
...
///
/// ```dart
/// QonduitMarkdownWidget(
///   data: '# Hello\n\nSome **bold** text.',
///   onLinkTap: (url, title) => launchUrl(Uri.parse(url)),
/// )
/// ```
class QonduitMarkdownWidget extends StatefulWidget {
  ...
  @override
  State<QonduitMarkdownWidget> createState() => _QonduitMarkdownWidgetState();
}

class _QonduitMarkdownWidgetState extends State<QonduitMarkdownWidget> {
