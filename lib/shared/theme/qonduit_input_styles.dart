...
///
/// Use via `context.qonduitInputStyles` or construct directly
/// with a [QonduitThemeExtension].
class QonduitInputStyles {
  /// Creates input styles backed by the given theme tokens.
  const QonduitInputStyles(this.theme);
...
/// Convenient access to [QonduitInputStyles] from a
/// [BuildContext].
extension QonduitInputStylesContext on BuildContext {
  /// Returns [QonduitInputStyles] using the nearest
  /// [QonduitThemeExtension].
  QonduitInputStyles get qonduitInputStyles =>
      QonduitInputStyles(qonduitTheme);
}
