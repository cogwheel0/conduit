...
class ReviewerModeService {
  ...
  static const Map<String, List<String>> _cannedResponses = {
    ...
    'general': [
      'That\'s an interesting question! Let me think about "{query}".\n\nIn Qonduit, you can explore various topics and get detailed responses. The app is designed to be your AI companion for learning, creating, and problem-solving.\n\n(Demo Mode: These are sample responses for app review)',
      'Regarding "{query}", here\'s what I can share:\n\nQonduit provides a seamless chat experience with advanced AI capabilities. Whether you\'re looking for information, creative assistance, or technical help, I\'m here to support you.\n\nNote: This is a demo response - actual usage requires your own AI server.',
      'I understand you\'re asking about "{query}". \n\nThis demo shows how Qonduit handles conversations. In real use, you\'d connect to your own AI server for actual AI responses.\n\nTry uploading an image or using voice input to see more features!',
    ],
    'error': [
      'I noticed there might be an issue. In a production environment, Qonduit handles errors gracefully and provides helpful feedback. This demo mode simulates that experience.\n\nPlease try your request again, or let me know how I can help differently!',
      'It seems something unexpected happened. Qonduit is designed to recover smoothly from errors and continue providing assistance.\n\nWould you like to try a different query or explore another feature?',
    ],
  };
