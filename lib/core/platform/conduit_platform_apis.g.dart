...
class PlatformNativeSheetItem {
  ...
  static PlatformNativeSheetItem decode(Object result) {
    ...
    return PlatformNativeSheetItem(
      ...
      dismissOnSelect: result[5]! as bool,
      actionId: result[6] as String?,
      actionValue: result[7],
      url: result[8] as String?,
      kind: result[9]! as PlatformNativeSheetItemKind,
      value: result[10],
      placeholder: result[11] as String?,
      options: (result[12]! as List<Object?>).cast<PlatformNativeSheetOption>(),
      sourceIndex: result[13] as int?,
      sourceUrl: result[14] as String?,
      sourceType: result[15] as String?,
      snippet: result[16] as String?,
      faviconUrl: result[17] as String?,
      queries: (result[18]! as List<Object?>).cast<String>(),
      links: (result[19]! as List<Object?>).cast<PlatformNativeSheetLink>(),
      pending: result[20]! as bool,
      min: result[21] as double?,
      max: result[22] as double?,
      divisions: result[23] as int?,
    );
  }
