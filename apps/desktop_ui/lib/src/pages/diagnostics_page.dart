...
/// Exercises the router features the app relies on: a path parameter, and
...
/// which is what `conduit://` deep links push.
class DiagnosticsPage extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    return div(classes: 'mx-auto max-w-2xl px-8 py-10 text-foreground', [
      ...
      Link(
        to: '/',
        classes: 'mt-6 inline-block text-ui-base text-primary underline',
